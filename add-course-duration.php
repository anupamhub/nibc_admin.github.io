<?php 
	...
	define ("title", "Add Course Duration");
	define ("page_name", "Add Course Duration");
	$msg=null;
?>
<?php
if(isset($_POST['submit']))	{
		...
		$sql=$conn->prepare("INSERT INTO course_duration SET name=?, url_key=?, status=?, date_created=?, date_modified=?");
  
    $sql->bind_param("ssiss", $name, $url_key, $status, $date_created, $date_created);
    $sql->execute();
