			...
			<div class="col-12">
			  <div class="card">
				<div class="card-header">
				  ...
				  <a href="add-course-duration.php">
				...
				<div class="card-body">
				  <table id="example1" class="table table-bordered table-hover">
					...
					<tbody>
						<?php 
						$ctr = 0;
						$course_duration = $conn->query("SELECT * FROM course_duration");
						while($row = $course_duration->fetch_assoc()){
							$ctr++;
						?>
					<tr>
						<td><?php echo $ctr; ?></td>
					  ...
					  <td><?php if($row['status']==1) {echo "<div class='mb-xs mt-xs mr-xs btn btn-sm btn-success mbr-5'>Active</div>";} else{ echo "<div class='mb-xs mt-xs mr-xs btn btn-sm btn-warning mbr-5'>InActive</div>";} ?></td>
						<td>
							<a href="edit-course-duration.php?cid=<?php echo $row['id']?>" class="btn btn-sm btn-primary mbr-5">
