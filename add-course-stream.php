<?php 
	...
	define ("title", "Add Course Stream");
	define ("page_name", "Add Course Straem");
	$msg=null;
?>
<?php
if(isset($_POST['submit']))	{
		...
		$sql=$conn->prepare("INSERT INTO course_stream SET name=?, url_key=?, status=?, date_created=?, date_modified=?");
