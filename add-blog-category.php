<?php 
	...
	define ("title", "Add Blog Category");
	define ("page_name", "Add Blog Category");
	$msg=null;
?>
<?php
$msg=null;
if(isset($_POST['submit']))	{
	...
	// End Url Key-------------------------
		...
		$sql=$conn->prepare("INSERT INTO blog_category SET title=?, description=?, url_key=?, status=?, date_created=?, date_modified=?");
  
    $sql->bind_param("sssiss", $title, $description, $url_key, $status, $date_created, $date_modified);
    $sql->execute();
