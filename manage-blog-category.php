<?php 
    ...
    define ("title", "Manage Blog Category");
    define ("page_name", "Manage Blog Category");
...
//========================================================================================================
  ...
  //===========================================================================================================
    ...
    if(isset($_GET['did'])){
              if ($stmt=$conn->prepare ("DELETE from blog_category WHERE id='".$_GET['did']."' ")){
                $stmt->execute();
          ...
          if(isset($_GET['aid'])){
            if($sql = $conn->prepare("UPDATE blog_category SET status='1' WHERE id ='".$_GET['aid']."' ")) {
              $sql->execute();
          ...
          if(isset($_GET['inid'])){
             if($sql = $conn->prepare("UPDATE blog_category SET status='0' WHERE id ='".$_GET['inid']."' ")) {
                $sql->execute();
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php
                    $sl=$conn->query("SELECT * FROM blog_category ORDER BY id DESC LIMIT $start_from,$limit");
                  ...
                  echo date_format($date,"d/m/Y"); ?></td>
                    ...
                    <td><?php if($row['status'] == '1'){echo "<span class='btn btn-success'>Active</span>";}else{ echo "<span class='btn btn-warning'>Inactive</span>"; } ?></td>
                    <td>
                        <a href="edit-blog-category.php?cid=<?php echo $row['id']?>" class="btn btn-sm btn-primary mbr-5">
         ...
         <li>
          ...
          <?php }else{ ?>
            <li class="paginate_button previous">
              <a href="manage-blog-category.php?page=<?= ($page-1);?>">PREV</a>
            </li>
            <li class=""><a href="manage-blog-category.php?page=1" >1</a></li>
        ...
        ?>
          <li class="paginate_button <?php if($page == $i){echo 'active';}else{ echo ''; } ?>"><a href="manage-blog-category.php?page=<?= $i;?>" ><?= $i;?></a></li>
        <?php
          }
        ?>
        ...
        <li class="pg-text">
          ...
          <li class="paginate_button active"><a href="manage-blog-category.php?page=<?= $total_pages;?>" ><?= $total_pages;?></a></li>
        ...
        <?php }else{?>
          ...
          <li class="paginate_button"><a>...</a></li>
          <li class="paginate_button"><a href="manage-blog-category.php?page=<?= $total_pages;?>" ><?= $total_pages;?></a></li>
          <li class="paginate_button next">
            <a href="manage-blog-category.php?page=<?= ($page+1);?>">NEXT</a>
          </li>
        <?php }?>
        </li>
            </ul>
